...
for i in range(100000):
    ...
    # Train generator
    z_batch = np.random.normal(0, 1, size=[batch_size, z_dimensions])
    gLoss, _ = sess.run([g_loss, g_trainer], feed_dict={z_placeholder: z_batch})
    
    if i % 10 == 0:
        print("Step = {}, D_Real_Loss={:.4g}, D_Fake_Loss={:.4g}, Gen_Loss={:.4g}".format(i+1, dLossReal, dLossFake, gLoss))
