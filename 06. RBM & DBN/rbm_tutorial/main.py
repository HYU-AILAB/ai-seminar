...
flags.DEFINE_integer('epochs', 25, 'The number of training epochs')
...
rbmobject1 = RBM(500, 250, ['rbmw3', 'rbvb3', 'rbmhb3'], 0.3)
rbmobject2 = RBM(250, 2  , ['rbmw4', 'rbvb4', 'rbmhb4'], 0.3)

if FLAGS.restore_rbm:
    rbmobject1.restore_weights('.tutorial_out/rbmw1.chp')
    rbmobject1.restore_weights('.tutorial_out/rbmw2.chp')
