# AI Seminar Season #12 (May 18, 2020 - June 22, 2020)
[한양대학교 인공지능연구실](http://ai.hanyang.ac.kr/)에서 매주 진행하는 AI Seminar 발표 자료 및 구현 코드를 담고 있습니다. Season #12 은 각자 Deep Learning 관련 paper을 선정하여 세미나를 진행합니다.
...
|12 | [Season 12 : Deep Learning 자율 주제 세미나](https://github.com/HYU-AILAB/ai-seminar) | May 18, 2020 - June 22, 2020 |

## Seminar Rules
* 매주 **월요일 6시**에 시작하여, 발표 당 시간은 **60분 이내**로 진행한다.
...
| #  | Presenter | Subject |
|:--:|:---------:|:-------:|
| 01 |  서영민   | Spatial temporal graph convolutional networks for skeleton-based action recognition |
| 02 |  조충현   | SYNTHESIZER: Rethinking Self-Attention in Transformer Models |
| 03 |  조건희   | Visual Word2Vec (vis-w2v): Learning Visually Grounded Word Embeddings Using Abstract Scenes |
| 04 |  김유리   | M3ER: Multiplicative Multimodal Emotion Recognition Using Facial, Textual, and Speech Cues |
| 05 |  이은수   | ALBERT: A Lite BERT for Self-supervised Learning of Language Representations |
| 06 |  박소영   | Few-Shot Adversarial Learning of Realistic Neural Talking Head Models |
| 07 |  정지은   | Human Attention in Visual Question Answering: Do Humans and Deep Networks Look at the Same Regions? |
| 08 |   이봉석   | Classifying Relations via Long Short Term Memory Networks along Shortest Dependency Paths |
| 09 | 김웅희 | Deep contextualized word representations |
| 10 | 오지은 | Unupervised Machine Translation Using Monolingual Corpora Only |
| 11 | 최원혁 | Bottom-Up and Top-Down Attention for Image Captioning and Visual Question Answering |
